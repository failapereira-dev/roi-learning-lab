    ...
    if (isProfessor) {
        ...
        if (appState.activeTab === "groupwork") {
            if (appState.activeClassId === "aula1" && activity1Container) {
                ...
                if (limitationsPanel) {
                    const isAtBCSubmission = (appState.activeSlideId === "slide_3_16" || appState.activeSlideId === "slide_3_17" || appState.activeSlideId === "slide_3_18" || appState.activeSlideId === "slide_3_19" || appState.activeSlideId === "slide_3_20" || appState.activeSlideId === "slide_3_21_ref" || appState.activeSlideId === "slide_3_22");
